  ...
  return (
   <div id='work' className="mywork">
    ...
    <div className="mywork-container">
        {
            [{id:1, title:"Times of India Website", desc:`Designed and developed event-specific web pages for high-traffic live events such as Sports tournaments,
elections, astrology, and weather updates, integrating real-time APIs for dynamic content.`, img:"../../../public/ecommerce.png"},
{id:3, title:"Analytics Dashboard", desc:`Designed and developed a Dashboard web application to automate healthcare data processing and generate
analytical reports. The platform allows users to configure parameters, validate data formats, and ensure data consistency`, img:"https://www.shutterstock.com/image-vector/project-management-concept-illustration-260nw-1937586670.jpg"},
            {id:2, title:"Social Media Platform", desc:`Designed and developed a Dashboard web application to automate healthcare data processing and generate
